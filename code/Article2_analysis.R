        ...
        ## Plots
        get_plot_2par <- function(df, cols= mycolors[c(1,2,7,8)], plottype, N = 4){ # n is the maximum OPG for end of geom_line
          if(plottype != "TOL"){
        ...
        get_plot_1par <- function(df, cols= mycolors, plottype, N = 4){ # n is the maximum OPG for end of geom_line
