...
```{r menu, fig.cap = "papaja's APA6 template is available through the RStudio menues.", fig.align = "center"}
knitr::include_graphics("../inst/images/template_selection.png", dpi = 108)
```

```{r knit, fig.cap = "The Knit button in the RStudio.", fig.align = "center"}
knitr::include_graphics("../inst/images/knitting.png", dpi = 108)
```
...
```{r beeplot, fig.cap = "Bee plot of the example data set. Small points represent individual observations, large points represent means, and error bars represent 95% confidence intervals.", echo = TRUE, dev.args = list(bg = 'white')}
apa_beeplot(
  mixed_data
  , id = "Subject"
  , dv = "Recall"
