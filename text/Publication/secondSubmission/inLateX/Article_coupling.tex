%%%%%%%%%%%%  Alice Balard template May 2020  %%%%%%%%%%%%%%
...
\bibliography{PhDthesis2305.bib}
...
\hl{If all possible responses were demonstrated what did you expect to show in your experiments?
Why do not relate all that stuff to your finding on Eimeria infections in the context of HZ, which would be tractable also for evolutionary biologists? E.g. do hybrids react in different way to parasite infections when compared to parental genotypes? }
