...
We wish to submit an original research article entitled “Coupling between tolerance and resistance differs between related \textit{Eimeria} parasite species: implications for co-evolution with their mouse hosts” for consideration by Ecology and Evolution. We build on previous research showing that resistance and tolerance should be studied jointly, and show that coupling of the two can differ between closely related parasite taxa.\par

Testing whether closely related parasite species could show differences in coupling between tolerance and resistance, we found a trade-off between resistance and tolerance to one, \textit{E. falciformis}, but not to its close relative \textit{E. ferrisi}. Our work has direct implications for the evolutionary question of effects of parasites in hybrid zones. Moreover, we argue that the framework of resistance-tolerance coupling allows to prioritize research questions to be addressed with different parasites: broad questions of relevance for the host species as a whole with parasites showing no coupling, questions of host-parasite co-evolution with parasites showing coupling. \par

We think that this work will be of both general interest for evolutionary biologists working on parasites, and for specialised research on the house mouse hybrid zone. Thank you for your consideration of this manuscript. \par
Sincerely,\\
The authors
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{images/Table1_final.eps}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{images/Table2_final.eps}
	\captionsetup{labelformat=empty}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{images/Fig1_final.eps}
  \caption{Parasite isolates and mouse wild-derived strains.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{images/Fig2_final.eps}
  \caption{Parasite density (A) and relative weight (B) during \textit{Eimeria} infection.}
\end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth,height=\textheight,keepaspectratio]{images/Fig3_final.eps}
